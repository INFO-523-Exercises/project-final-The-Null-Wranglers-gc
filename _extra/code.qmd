...
```{r}
# mean and median of each semester

```


```{r}
# mean enrollment for course level by semester

```

```{r}
# facet wrap of colleges of upper and lower per semester
```

```{r}
# facet wrap of colleges of mean enrollment per semester

```

```{r}
# facet wrap of departments in top enrollemnt college of upper and lower per semester
